...
if __name__ == "__main__":
    ...
    example_config = {
        ...
        "pretrained_wallx_path": "/data2/konghanlin/new_wallx/wallx_pt/Qwen2.5-VL-3B_noMOE_tiny/98/processor",  # 目录下应有 *.safetensors 与 tokenizer/processor
    ...
    path = "/data2/konghanlin/new_wallx/workspace/lerobot_example/UAV_tiny/qwen2.5-3B-noMOE/config_qact.yml"
    ...
    if instruction_text:
        ...
        fig.text(0.02, 0.02, instruction_text, fontsize=6, color='black', wrap=True,
                 ha='left', va='bottom')
    save_path = "/data2/konghanlin/new_wallx/open_loop_figs"
