...
if __name__ == "__main__":
    ...
    save_dir = "/data2/konghanlin/new_wallx/open_loop_figs/wall-oss-fast-withMOE"
    path = "/data2/konghanlin/new_wallx/workspace/lerobot_example/UAV_train/wall-oss_fast-withMOE/config_qact.yml"
    ...
    dataset = load_test_dataset(config, lerobot_config, episode = list(range(1450)),seed=42)
