...
if __name__ == "__main__":
    ...
    model_path = "/data2/konghanlin/new_wallx/wall_pt/wall-oss-flow-withMOE/43/processor"
    ...
    path = "/data2/konghanlin/new_wallx/workspace/lerobot_example/UAV_train/wall-oss_flow-withMOE/config_qact.yml"
