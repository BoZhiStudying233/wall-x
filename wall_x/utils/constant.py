action_statistic_dof = {
    "dzb/our_data_tiny": {
        "position": {
            "min":[0.0, -1.1440000534057617, -0.08799999952316284],
            "delta":[1.7786, 6.4916, 0.5077]
        },
        "rotation": {
            "min":[0.0006959981401450932,-0.02776399627327919,-1.147138237953186],
            "delta":[0.0417,1.490701,1.358]
        }
    },
    "dzb/our_data_test": {
        "position": {
            "min":[-5.58736, -2.98299, -0.5126],
            "delta":[11.2836, 6.4916, 0.6994]
        },
        "rotation": {
            "min":[-0.01674,-0.032004,-3.115811],
            "delta":[0.0417,0.04413,6.2197]
        }
    },
    "dzb/our_data_train": {
        "position": {
            "min":[-5.58924531, -2.9944, -0.51435],
            "delta":[10.9946537, 6.568372249603, 1.035487413]
        },
        "rotation": {
            "min":[-0.01221735,-0.014715,-1.68389654],
            "delta":[0.02564060,0.028213389,3.4014921188]
        }
    },
    "x2_normal": {
        # water flowers
